...
const Services = () => {
  ...
  return (
    ...
    >
      <div className="bg-logo-black pointer-events-none absolute inset-0 flex items-center justify-center [mask-image:radial-gradient(ellipse_at_center,transparent_50%,black)]" />
      <AnimatePresence>
        {!isContentVisible && (
          <motion.div
          ...
          >
            <div className="w-full max-w-7xl p-7">
              ...
              <div className="my-6 flex items-center text-nowrap">
                ...
                >
                  <span className="text-logo-yellow">Services</span> we offer
                </motion.h1>
                <motion.div
              ...
              <motion.p
                ...
                className="text-logo-white mt-10 font-[ClashDisplay] text-[clamp(.9rem,3vw,1.125rem)] leading-loose font-normal md:leading-[44px]"
              >
