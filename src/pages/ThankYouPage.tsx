...
const ThankYouPage = () => {
  return (
    <div className="flex h-screen w-full items-center justify-center bg-[#1E1E1E]">
      <div className="bg-striped flex max-w-4xl flex-col items-center justify-center gap-5 border-x-5 border-[#504F4F]/20 p-5 text-center md:p-20">
        <h1 className="font-[ClashDisplay] text-[clamp(1.5rem,3vw,5rem)] font-medium text-pretty text-[#FCAC04]">
          Thanks for the message!
        </h1>
        <p className="font-[SansationLight] text-[clamp(.8rem,2vw,1.125rem)] font-normal text-[#D9D9D9]">
